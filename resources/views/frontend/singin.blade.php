...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/frontend/css/singin.css')}}" />
</head>
<body>
    <div class="container">
        <div class="overlay" id="overlay">
          <div class="sign-in" id="sign-in">
            ...
            <p>Hãy kết nối để tìm những người bạn mới</p>
            <button class="switch-button" id="slide-right-button">Sign In</button>
          </div>
          <div class="sign-up" id="sign-up">
            <h1>Xin chào</h1>
            <p>Hãy đăng kí để trở thành thành viên mới</p>
        ...
        <div class="form">
          <div class="sign-in" id="sign-in-info">
            ...
            <form id="sign-in-form" action="{{ url('handle-singin') }} " method="post">  
              @csrf    
              {{ csrf_field()}}
              <input type="email" placeholder="Email" name = 'username'/>
              <input type="password" placeholder="Password" name = 'password'/>
              <p class="forgot-password">Forgot your password?</p>
              <button class="control-button in" type="submit">Đăng nhập</button>
            </form>
          </div>
          <div class="sign-up" id="sign-up-info">
            ...
            <form id="sign-up-form">
              ...
              <button class="control-button up">Đăng kí</button>
            </form>
          </div>
        </div>
      </div>
      <script src="{{asset('/frontend/js/singin.js')}}"></script>
</body>
</html>